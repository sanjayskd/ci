              ...
              <ul class="dropdown-menu">
			   ...
			   <li><a href="design.php">Design</a></li>
			    <li><a href="business.php">Business</a></li>
				 <li class="active"><a href="world.php">World</a></li>
	...
	<div class="container">
		<div class="col-md-9 technology-left">
			<div class="business">
				<div class="rev-1">
					<div class="rev-img">
						<a href="singlepage.php"><img src="images/1.jpg" class="img-responsive" alt=""></a>
					</div>
					<div class="rev-info">
						<h3><a href="singlepage.php">Incididunt ut labore et dolore</a></h3>
				...
				<div class="rev-1">
					<div class="rev-img">
						<a href="singlepage.php"><img src="images/2.jpg" class="img-responsive" alt=""></a>
					</div>
					<div class="rev-info">
						<h3><a href="singlepage.php">Consectetur adipisicing</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.isicing </p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="rev-1">
					<div class="rev-img">
						<a href="singlepage.php"><img src="images/3.jpg" class="img-responsive" alt=""></a>
					</div>
					<div class="rev-info">
						<h3><a href="singlepage.php">Ipsum dolor sit amet</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.isicing </p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="rev-1">
					<div class="rev-img">
						<a href="singlepage.php"><img src="images/4.jpg" class="img-responsive" alt=""></a>
					</div>
					<div class="rev-info">
						<h3><a href="singlepage.php">Sed do eiusmod tempor</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.isicing </p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="rev-1">
					<div class="rev-img">
						<a href="singlepage.php"><img src="images/5.jpg" class="img-responsive" alt=""></a>
					</div>
					<div class="rev-info">
						<h3><a href="singlepage.php">Dolore magna aliqua</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.isicing </p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="rev-1">
					...
					<div class="rev-info">
						<h3><a href="singlepage.php">Sit amet, consectetur</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.isicing </p>
					</div>
					<div class="clearfix"></div>
				</div>
