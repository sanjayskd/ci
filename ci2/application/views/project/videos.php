           ...
           <li class="active"><a href="videos.php">Videos</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="single.php">Action</a></li>
		...
		<div class="col-md-9 technology-left">
			<div class="vide">
				<iframe src="https://player.vimeo.com/video/21372344" width="100%" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					<h3><a href="singlepage.php"> Ut enim ad minim veniam, quis nostrud eiusmod tempor</a></h3>
			...
			<div class="vide-1">
				<iframe src="https://player.vimeo.com/video/18624866?title=0&byline=0&portrait=0" width="100%" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					<h3><a href="singlepage.php">Tempor incididunt ut labore et dolore magna aliqua</a></h3>
