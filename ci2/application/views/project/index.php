		...
		<div class="tech-no">
			...
			<div class="soci">
			 ...
			 <div class="tc-ch">
					...
					<div class="tch-img">
						<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/1.jpg"); ?>" class="img-responsive" alt="" /></a>
					</div>
					<a class="blog blue" href="singlepage.php">Technology</a>
					<h3><a href="singlepage.php">Lorem Ipsum is simply</a></h3>
...
<!--
			<div class="soci">
			 ...
			 <div class="tc-ch">
					...
					<div class="tch-img">
						<a href="singlepage.php"><img src="<?php //echo base_url("assets/front/images/2.jpg");?>" class="img-responsive" alt=""/></a>
					</div>
					<a class="blog pink" href="singlepage.php">Science</a>
					<h3><a href="singlepage.php">Lorem Ipsum is simply</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						<p>Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!--
			<div class="soci">
			 ...
			 <div class="tc-ch">
					...
					<div class="tch-img">
						<a href="singlepage.php"><img src="<?php //echo base_url("assets/front/images/3.jpg");?>" class="img-responsive" alt=""/></a>
					</div>
					<a class="blog gren" href="singlepage.php">Culture</a>
					<h3><a href="singlepage.php">Lorem Ipsum is simply</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						<p>Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!--
			 <div class="tc-ch">
					<div class="tch-img">
						<a href="singlepage.php"><img src="<?php //echo base_url("assets/front/images/4.jpg");?>" class="img-responsive" alt=""/></a>
					</div>
					<a class="blog orn" href="singlepage.php">Business</a>
					<h3><a href="singlepage.php">Lorem Ipsum is simply</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						<p>Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!--
					<div class="tch-img">
						<a href="singlepage.php"><img src="<?php //echo base_url("assets/front/images/5.jpg");?>" class="img-responsive" alt=""/></a>
					</div>
					<a class="blog blue" href="singlepage.php">Technology</a>
					<h3><a href="singlepage.php">Lorem Ipsum is simply</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud eiusmod tempor incididunt ut labore et dolore magna aliqua exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!--			 technology-top -->
		...
		<div class="col-md-3 technology-right">
				<div class="blo-top">
					<div class="tech-btm">
					<img src="<?php echo base_url("assets/front/images/banner1.jpg");?>" class="img-responsive" alt=""/>
					</div>
				</div>
				<div class="blo-top">
					<div class="tech-btm">
					...
					<h4>Top stories of the week </h4>
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/6.jpg");?>" class="img-responsive" alt=""/></a>
							</div>
						...
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/7.jpg");?>" class="img-responsive" alt=""/></a>
							</div>
							<div class="blog-grid-right">
						...
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/11.jpg");?>" class="img-responsive" alt=""/></a>
							</div>
							<div class="blog-grid-right">
						...
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/9.jpg");?>" class="img-responsive" alt=""/></a>
							</div>
							<div class="blog-grid-right">
						...
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="singlepage.php"><img src="<?php echo base_url("assets/front/images/10.jpg");?>" class="img-responsive" alt=""/></a>
							</div>
							<div class="blog-grid-right">
...
<!-- footer-bottom -->
	...
	<div class="container">
		<ul>
			...
			<li><a href="singlepage.php">Culture</a></li>
			<li><a href="singlepage.php">Science</a></li>
			<li><a href="design.php">Design</a></li>
			<li><a href="business.php">Business</a></li>
			<li><a href="world.php">World</a></li>
			<li><a href="forum.php">Forum</a></li>
